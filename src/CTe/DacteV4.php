...
class DacteV4 extends DaCommon
{
    ...
    protected $wAdic = 150;
    protected $docsPrimeiraPag = 24;
    protected $docsPagAdic = 116;
    ...
    protected function monta(
        ...
        //coloca o cabeçalho
        $y = $this->canhoto($x, $y);
        $y = $this->cabecalho($x, $y, $pag, $totPag);
        $r = $this->remetente($x, $y);
        $x = $xInic + ($this->wPrint * 0.5);
    ...
    protected function cabecalho($x = 0, $y = 0, $pag = '1', $totPag = '1')
    {
        ...
        $this->pdf->textBox($x1, $y1, $w, 8, $texto, $aFont, 'T', 'C', 0, '');
        //endereço
        $y1 = $y1 + 2;
        $aFont = array(
            'font' => $this->fontePadrao,
        ...
        if ($toma == 1) {
            ...
            $this->pdf->textBox($x + 3.5, $y2 + 3.5, $w * 0.5, $h1, 'X', $aFont, 'T', 'L', 0, '', false);
        } else {
            $aFont = array(
                'font' => $this->fontePadrao,
                'size' => 11,
            ...
            $this->pdf->textBox($x + 18.5, $y2 + 3.5, $w * 0.5, $h1, 'X', $aFont, 'T', 'L', 0, '', false);
        }
        $aFont = $this->formatNegrito;
        ...
        $this->pdf->textBox($x + 8, $y2 + 4.4, $w * 0.5, $h1, 'SIM', $aFont, 'T', 'L', 0, '', false);
        ...
        $this->pdf->textBox($x + 23, $y2 + 1.4 + 3, $w * 0.5, $h1, 'NÃO', $aFont, 'T', 'L', 0, '', false);
        //FORMA DE PAGAMENTO
        ...
        $this->pdf->textBox($x1, $y + 5, $w2, $h, $texto, $aFont, 'T', 'C', 0, '');
        //outra caixa
        $y += 12;
        $h = 9;
        //$w = $w1 + $w2 + 2;
        ...
        $this->pdf->textBox($x, $y + $h1, $w, $h1 - 6);
        ...
        $this->pdf->textBox($x, $y + $h1 + 8, $w, $h1 - 4.5);
        ...
        $aFont = $this->formatNegrito;
        $this->pdf->textBox($x, $y + 11, $wa, $h, $texto, $aFont, 'T', 'C', 0, '');
        if ($this->qrCodCTe !== null) {
            $this->qrCodeDacte($y - 28, $x + $w, $w2);
            $this->pdf->textBox($x + $w, $y - 34, $w2, $h + 41.5);
        }
        //CFOP
        $x = $oldX;
        $h = 8.5;
    ...
    protected function remetente($x = 0, $y = 0)
    {
        ...
        $this->pdf->textBox($x1, $y - 0.4, $w - 18, $h, $texto, $aFont, 'T', 'L', false, '', true);
        $y += 3.5;
        $texto = 'ENDEREÇO:';
        $aFont = $this->formatPadrao;
        $this->pdf->textBox($x, $y, $w, $h, $texto, $aFont, 'T', 'L', 0, '');
        ...
        $this->pdf->textBox($x1, $y - 0.3, $w, $h, $texto, $aFont, 'T', 'L', 0, '');
        $y += 3;
        ...
        $aFont = $this->formatNegrito;
        $this->pdf->textBox($x1, $y - 0.3, $w - $x1 - 18, $h, $texto, $aFont, 'T', 'L', 0, '');
        $x = $w - 18;
        $texto = 'CEP:';
        $aFont = $this->formatPadrao;
        $this->pdf->textBox($x, $y, $w, $h, $texto, $aFont, 'T', 'L', 0, '');
        ...
        $aFont = $this->formatNegrito;
        $this->pdf->textBox($x + 6, $y - 0.3, $w, $h, $texto, $aFont, 'T', 'L', 0, '');
        $x = $oldX;
        $y += 3;
        $texto = 'CNPJ/CPF:';
        $aFont = $this->formatPadrao;
        ...
        $aFont = $this->formatNegrito;
        $this->pdf->textBox($x1, $y - 0.3, $w, $h, $cpfCnpj, $aFont, 'T', 'L', 0, '');
        $x = $w - 45;
        ...
        $aFont = $this->formatNegrito;
        $this->pdf->textBox($x + 25, $y - 0.3, $w, $h, $texto, $aFont, 'T', 'L', 0, '');
        $x = $oldX;
        $y += 3;
        $texto = 'PAÍS:';
        $aFont = $this->formatPadrao;
        ...
        $aFont = $this->formatNegrito;
        $this->pdf->textBox($x + 7, $y - 0.3, $w, $h, $texto, $aFont, 'T', 'L', 0, '');
    }
    ...
    protected function destinatario($x = 0, $y = 0)
    {
        ...
        $this->pdf->textBox($x1, $y - 0.3, $w - 18, $h, $texto, $aFont, 'T', 'L', false, '', true);
        $y += 3.5;
        $texto = 'ENDEREÇO:';
        $aFont = $this->formatPadrao;
        $this->pdf->textBox($x, $y, $w, $h, $texto, $aFont, 'T', 'L', 0, '');
        ...
        $aFont = $this->formatNegrito;
        $this->pdf->textBox($x1, $y - 0.3, $w - 19 - 23, $h, $texto, $aFont, 'T', 'L', 0, '');
        $x = $w - 23 + $oldX;
        $texto = 'CEP:';
        $aFont = $this->formatPadrao;
        $this->pdf->textBox($x, $y, $w, $h, $texto, $aFont, 'T', 'L', 0, '');
    ...
    protected function recebedor($x = 0, $y = 0)
    {
        ...
        $this->pdf->textBox($x1, $y - 0.3, $w - 18, $h, $texto, $aFont, 'T', 'L', 0, '');
        $y += 3.5;
        $texto = 'ENDEREÇO:';
        $aFont = $this->formatPadrao;
        $this->pdf->textBox($x, $y, $w, $h, $texto, $aFont, 'T', 'L', 0, '');
        ...
        $aFont = $this->formatNegrito;
        $this->pdf->textBox($x + 2, $y - 0.3, $w, $h, $texto, $aFont, 'T', 'L', 0, '');
        $x = $oldX;
        $y += 3;
        $texto = 'CNPJ/CPF:';
        $aFont = $this->formatPadrao;
    ...
    protected function tomador($x = 0, $y = 0)
    {
        ...
        $this->pdf->textBox($x + 27, $y - 0.3, $w - ($maxW * 0.60), $h, $texto, $aFont, 'T', 'L', 0, '');
        $x = $maxW * 0.60;
        $texto = 'MUNICÍPIO:';
        $aFont = $this->formatPadrao;
        $this->pdf->textBox($x, $y, $w, $h, $texto, $aFont, 'T', 'L', 0, '');
        ...
        $aFont = $this->formatNegrito;
        $this->pdf->textBox($x + 13, $y - 0.3, $w, $h, $texto, $aFont, 'T', 'L', 0, '');
        $x = $maxW * 0.85;
        $texto = 'UF:';
        $aFont = $this->formatPadrao;
        $this->pdf->textBox($x, $y, $w, $h, $texto, $aFont, 'T', 'L', 0, '');
        ...
        $aFont = $this->formatNegrito;
        $this->pdf->textBox($x + 4, $y - 0.3, $w, $h, $texto, $aFont, 'T', 'L', 0, '');
        $x = $w - 18;
        $texto = 'CEP:';
        $aFont = $this->formatPadrao;
        $this->pdf->textBox($x, $y, $w, $h, $texto, $aFont, 'T', 'L', 0, '');
        ...
        $this->pdf->textBox($x + 15, $y - 0.3, $w, $h, $texto, $aFont, 'T', 'L', 0, '');
        $y += 3.5;
        $texto = 'CNPJ/CPF:';
        $aFont = $this->formatPadrao;
        $this->pdf->textBox($x, $y, $w, $h, $texto, $aFont, 'T', 'L', 0, '');
        ...
        $aFont = $this->formatNegrito;
        $this->pdf->textBox($x + 26, $y - 0.3, $w, $h, $texto, $aFont, 'T', 'L', 0, '');
        $x = $w * 0.75;
        $texto = 'PAÍS:';
        $aFont = $this->formatPadrao;
        $this->pdf->textBox($x, $y, $w, $h, $texto, $aFont, 'T', 'L', 0, '');
        ...
        $aFont = $this->formatNegrito;
        $this->pdf->textBox($x + 8, $y - 0.3, $w, $h, $texto, $aFont, 'T', 'L', 0, '');
    }
    ...
    protected function descricaoCarga($x = 0, $y = 0)
    {
        ...
        $this->pdf->textBox($x + 2, $y + 3, $wa, $h, $texto, $aFont, 'T', 'C', 0, '');
    ...
    protected function compValorServ($x = 0, $y = 0)
    {
        ...
        $aFont = $this->formatPadrao;
        $this->pdf->textBox($x, $y, $w * 0.16, $h, $texto, $aFont, 'T', 'C', 0, '');
        ...
        $this->pdf->textBox($x, $y + 4, $w * 0.16, $h, $texto, $aFont, 'T', 'C', 0, '');
        $y += 10;
        $this->pdf->line($x, $y, $x + ($w * 0.16), $y);
        $y += 1;
    ...
    protected function docOrig($x = 0, $y = 0)
    {
        ...
        $descr3 = 'SÉRIE/NRO. DOCUMENTO';
        $y += 3.4;
        $this->pdf->line($x, $y, $w + $x, $y); // LINHA ABAIXO DO TEXTO: "DOCUMENTOS ORIGINÁRIOS
        $texto = $descr1;
        $aFont = $this->formatPadrao;
        $this->pdf->textBox($x, $y, $w * 0.10, $h, $texto, $aFont, 'T', 'L', 0, '');
        $yIniDados = $y;
        ...
        if ($qtdDocs > $this->docsPrimeiraPag) {
            $this->flagDocOrigContinuacao = 1;
        }

        $this->totPag = (int) ceil(($qtdDocs - $this->docsPrimeiraPag) / $this->docsPagAdic) + 1;


        $contador = 0;
        while ($contador < count($this->infNF)) {
            if ($contador == $this->docsPrimeiraPag) {
                break;
            }

            $mod = $this->infNF->item($contador)->getElementsByTagName('mod');
            $tp = ($mod && $mod->length > 0) ? $mod->item(0)->nodeValue : '';
            $cnpj = $this->formatCNPJCPF($this->rem);
            $doc = $this->infNF->item($contador)->getElementsByTagName('serie')->item(0)->nodeValue;
            $doc .= '/' . $this->infNF->item($contador)->getElementsByTagName('nDoc')->item(0)->nodeValue;
            if ($auxX > $w * 0.90) {
                $yIniDados = $yIniDados + 3.5;
                $auxX = $oldX;
            }
        ...
        $contador = 0;
        while ($contador < count($this->idDocAntEle)) {
            if ($contador == $this->docsPrimeiraPag) {
                break;
            }
            $tp = 'CT-e';
            $chaveCTe = $this->idDocAntEle->item($contador)->getElementsByTagName('chCTe')->item(0)->nodeValue;
    ...
    protected function docOrigContinuacao($x = 0, $y = 0)
    {
        ...
        for ($i = 2; $i <= $this->totPag; $i++) {
            ...
            $x = $oldX;
            $this->pdf->AddPage($this->orientacao, $this->papel);
            $y = $this->cabecalho($this->margesq, $this->margsup, $i, $this->totPag);
            ...
            $yIniDados += 3;
            while ($contador < (count($this->arrayNFe))) {
                if ($contador % ($this->docsPagAdic * ($i - 1) + $this->docsPrimeiraPag) == 0) {
                    break;
                }
                $tp = 'NF-e';
                $chaveNFe = $this->arrayNFe[$contador];
    ...
    protected function modalRod($x = 0, $y = 0)
    {
        ...
        if ($this->lota == 1) {
            $this->pdf->line($x, $y + 12, $w + $x, $y + 12); // LINHA DE BAIXO
        }
        $y += 3.4;
        $this->pdf->line($x, $y, $w + $x, $y); // LINHA DE CIMA
    ...
    protected function canhoto($x = 0, $y = 0)
    {
        ...
        $this->pdf->textBox($x, $y, $w, 4, null, null, 'C', 'C', 0, '', 0, 0, 0, 1);
        $this->pdf->textBox($x, $y, $w, 3, $texto, $aFont, 'C', 'C', 0);
        $y += 4;
        $texto = 'NOME';
        $aFont = array(
            'font' => $this->fontePadrao,
        ...
        $this->pdf->textBox($x, $y + 2.5, $w * 0.242, 6, '', '', 'B', 'C', 0, '', 0, 0, 0, 1); //Nome
        $this->pdf->textBox($x, $y + 0.2, $w * 0.25, 2, $texto, $aFont, 'T', 'L', 0, '');
        $texto = 'RG';
        $this->pdf->textBox($x, $y + 10.8, $w * 0.242, 6, '', '', 'B', 'C', 0, '', 0, 0, 0, 1); //RG
        $this->pdf->textBox($x, $y + 8.5, $w * 0.25, 2, $texto, $aFont, 'T', 'L', 0, '');


        $x += $w * 0.25;
        $this->pdf->textBox($x, $y + 1, $w * 0.25, $h - 6.5, '', '', 'B', 'C', 0, '', 0, 0, 0, 1);
        ...
        $this->pdf->textBox($x, $y + 0.5, $w * 0.25, $h - 3.4, $texto, $aFont, 'B', 'C', 0, '');
        $x += $w * 0.26;
        ...
        $this->pdf->textBox($x, $y + 1, $w * 0.25, 2.3, $texto, $aFont, 'T', 'C', 0, '', 0, 0, 0, 1);
        $this->pdf->line($x, $y + 8.5, $x + ($w * 0.17), $y + 8.5); //LINHA TERMINO PRESTACAO
        $this->pdf->line($x + ($w * 0.18), $y + 8.5, $x + ($w * 0.25), $y + 8.5); //LINHA TERMINO PRESTACAO
        
        $texto = 'INÍCIO DA PRESTAÇÃO - DATA/HORA';
        $this->pdf->textBox($x, $y + 9, $w * 0.25, 2.3, $texto, $aFont, 'T', 'C', 0, '', 0, 0, 0, 1);
        $this->pdf->line($x, $y + 17, $x + ($w * 0.17), $y + 17); //LINHA TERMINO PRESTACAO
        $this->pdf->line($x + ($w * 0.18), $y + 17, $x + ($w * 0.25), $y + 17); //LINHA TERMINO PRESTACAO

        $x = $oldX;
        $x += $w * 0.77;
        $texto = "CT-E";
        $aFont = $this->formatNegrito;
        $this->pdf->textBox($x, $y + 1, $w * 0.23, 2.3, null, null, 'T', 'C', 0, '', 0,0,0,1);
        $this->pdf->textBox($x, $y + 0.55, $w * 0.23, 2.3, $texto, $aFont, 'T', 'C', 0, '');
        $texto = "Nº DOCUMENTO";
        $aFont = array(
            'font' => $this->fontePadrao,
            'size' => 5,
        ...
        $this->pdf->textBox($x, $y + 3.5, $w * 0.23, 2, $texto, $aFont, 'T', 'L', 0, '');
        $this->pdf->textBox($x, $y + 5.8, $w * 0.23, 4.2, '', '', 'B', 'C', 0, '', 0, 0, 0, 1);
        $numCTe = str_pad($this->getTagValue($this->ide, "nCT"), 9, '0', STR_PAD_LEFT);
        $texto = $this->formatField($numCTe, "###.###.###");
        $this->pdf->textBox($x, $y + 5.8, $w * 0.23, 3.2, $texto, $this->formatNegrito, 'C', 'C', 0, '');
        $texto = "SÉRIE";
        $this->pdf->textBox($x, $y + 10.5, $w * 0.23, 2, $texto, $aFont, 'T', 'L', 0, '');
        $this->pdf->textBox($x, $y + 12.8, $w * 0.23, 4.2, '', '', 'B', 'C', 0, '', 0, 0, 0, 1);
        $texto = str_pad($this->getTagValue($this->ide, "serie"), 3, '0', STR_PAD_LEFT);
        $this->pdf->textBox($x, $y + 12.8, $w * 0.23, 3.2, $texto, $this->formatNegrito, 'C', 'C', 0, '');
        $x = $oldX;
        $y += 5;
        $this->pdf->dashedHLine($x, $y + 12.9, $this->wPrint, 0.1, 120);
    ...
    protected function dadosAdic($x, $y, $pag, $h)
    {
        ...
        $this->pdf->textBox($x, $y, $w * 0.7, $h, $texto, $aFont, 'T', 'C', 1, '');
        //$this->pdf->line($x, $y + 3, $w * 1.385, $y + 3);
        $this->pdf->line($x, $y + 3, $w + $x, $y + 3);
        ...
        $this->pdf->textBox($x, $y, $w * 0.3, $h, $texto, $aFont, 'T', 'C', 1, '');
    ...
    protected function qrCodeDacte($y = 0, $x = null, $size = 36)
    {
        ...
        $this->pdf->image($pic, $x, $yQr, $wQr, $hQr, 'PNG');
    }
}
