...
class Danfe extends DaCommon
{
     ...
     * @var boolean
     */
    public $exibirEmailDestinatario = false;
    /**
    ...
    //padrao do fork: linha solida entre as colunas dos itens
    ...
    protected function imposto($x, $y)
    {
        ...
        if ($this->exibirIcmsInterestadual) {
            ...
            $x = $this->impostoHelper($x, $y, $w, $h, "TRIBUTOS APROXIMADOS", "vTotTrib");
        }
        if ($this->exibirPIS) {
        ...
        foreach ($this->det as $d) {
            if ($i >= $nInicio) {
                ...
                if (!empty($veicProd)) {
                    ...
                    // linha entre itens
                    $this->pdf->dashedHLine($oldX, $y + 55, $w, 0.1, 120);
                    $y += 55;
                    $hUsado += 55;
                } else {
                    // linha entre itens
